...
export default function ProfileCard({nickname,icon,birthday,details,onStickerChange,disabled}:{nickname?:string;icon?:string;birthday?:string;details:ProfileDetails;onStickerChange?:(index:number,layout:StickerLayout)=>void;disabled?:boolean}){
 ...
 <div className="profile-art-title"><img src="/my-profile-umeboshi.svg" alt="MY PROFILE"/><h2 data-i18n-skip>{translate('{name}のプロフィール帳',locale,{name:nickname||translate('わたし',locale)})}</h2></div>
