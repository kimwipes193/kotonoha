...
export function DrawingCanvas({strokes,onChange,disabled=false,children}:{strokes:Stroke[];onChange?:(s:Stroke[])=>void;disabled?:boolean;children?:ReactNode}){
 ...
 const [hue,setHue]=useState(15),[ink,setInk]=useState('#242132'),[width,setWidth]=useState(4),[erase,setErase]=useState(false),[redo,setRedo]=useState<Stroke[][]>([]),[undo,setUndo]=useState<Stroke[][]>([]);
