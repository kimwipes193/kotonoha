...
export function checkDiary(value: unknown, withDrawing=false): string | null {
 if(typeof value !== 'string' || (!withDrawing&&value.trim().length<1) || value.length>1000) return '日記は1〜1,000文字で書いてください。';
