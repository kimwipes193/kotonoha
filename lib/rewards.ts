...
export const stickerNames:Record<string,string>={'🎂':'ぽすとのお祝いケーキ','🌷':'チューリップ','🍋':'小さなレモン','🐈':'おさんぽねこ','🦋':'青いちょうちょ','🌻':'ひまわり','🍒':'さくらんぼ','🍮':'ぷるぷるプリン','🍩':'穴までおいしい','🥐':'寝ぐせクロワッサン','🍙':'おにぎり休憩','☕':'ひと息コーヒー','🫖':'お茶にしましょう','🍓':'いちごのごきげん','🍄':'きのこの秘密基地','🐌':'急がない便','🐧':'ぺんぎん係長','🦦':'らっこの休日','🐳':'くじらのお便り','🌈':'雨あがり','🪐':'土星旅行','🌼':'小さな花','🎈':'ふわふわ風船','paper-blue':'空色の便箋','paper-pink':'桃色の便箋','🐾':'ぽすとの肉球印','💌':'はじめてのお便り','🏅':'交換の達人','🎀':'収集家のリボン'};
